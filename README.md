...
```console
bash variant_scoring.sh -o /test_run/ -i /test_run/ -v . -f /test_run/SDplots_frequencies/ -m /test_run/09-2024_month.txt/ -u /test_run/metadata_under_review.tsv/
```
...
|                                    | tp_sites.csv | file that contains curated list of known antigenic sites in the S1 subunit of the spike protein, from literature sources up through April 30, 2021 |
